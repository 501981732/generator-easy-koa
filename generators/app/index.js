...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    target = [...target,
      ...
      ['src/db/index.ejs', 'src/db/index.js'],
      ['src/controllers/user/controller.ejs', 'src/controllers/user/controller.js'],
      ['src/models/user.ejs', 'src/models/user.js'],
    ]
    // 是否添加单元测试
  ...
  // writeControllers() {
  //   this.fs.copyTpl(
  //     this.templatePath('src/controllers/controllerName/controllers.ejs'),
  //     this.destinationPath('src/controllers/' + this.options.componentName + '/controllers.js'), { controllerName: this.options.controllerName }
  //   );
  //   this.fs.copyTpl(
  //     this.templatePath('src/controllers/controllerName/router.ejs'),
  //     this.destinationPath('src/controllers/' + this.options.componentName + '/router.js'), { controllerName: this.options.controllerName }
  //   );
  //   this.fs.copyTpl(
  //     this.templatePath('src/models/models.ejs'),
  //     this.destinationPath('src/models/' + this.options.componentName + '.js'), { controllerName: this.options.controllerName }
  //   );
  // }
  install() {
